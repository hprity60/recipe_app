...
class Recipe {
    ...
    factory Recipe.fromJson(Map<String, dynamic> json) => Recipe(
        ...
        mealType: List<MealType>.from(json["mealType"].map((x) => mealTypeValues.map[x]!)),
        dishType: List<DishType>.from(json["dishType"].map((x) => dishTypeValues.map[x]!)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "mealType": List<dynamic>.from(mealType.map((x) => mealTypeValues.reverse[x])),
        "dishType": List<dynamic>.from(dishType.map((x) => dishTypeValues.reverse[x])),
